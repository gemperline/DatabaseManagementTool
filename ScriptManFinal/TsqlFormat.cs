...
namespace Manoli.Utils.CSharpFormat
{
    ...
    public class TsqlFormat : CodeFormat
    {
        ...
        /// <summary>
        /// Regular expression string to match comment blocks.  Added by Russ Thomas 3/13/2013
        /// </summary>
        protected override string CommentBlockRegEx
        {
            get
            {
                return @"/\*([^*]|[\r\n]|(\*+([^*/]|[\r\n])))*\*+/";
        ...
        /// <summary>
        /// Regular expression string to match variables 
        /// </summary>
        protected override string VariableRegEx
        {
            get
            {
                //return @"(^@).*?(?=\s|;|\=)";
